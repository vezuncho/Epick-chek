...
const CACHE_VERSION='epi-check-ford-transit-v3';
const APP_SHELL=['./index.html','./manifest.json','./icon-192.png','./icon-512.png','./js/17-supabase-photos.js','./js/18-ford-transit-profile.js','./assets/ford-transit-armario.png'];
