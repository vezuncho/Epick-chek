...
const CACHE_VERSION='epi-check-perfiles-furgoneta-v4-ford-transit';
const APP_SHELL=['./manifest.json','./icon-192.png','./icon-512.png','./js/17-supabase-photos.js','./ford-transit-armario-herramientas.png'];
