...
const CACHE_VERSION='epi-check-personal-five-steps-fixed-v2';
const APP_SHELL=['./index.html','./manifest.json','./icon-192.png','./icon-512.png','./assets/ford-transit-armario.png'];
