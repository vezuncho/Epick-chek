...
## Ajuste de formularios — 23/07/2026
- Botón **Aceptar** añadido junto a **Cerrar** en la cabecera de alta/edición de materiales y EPIs.
- Eliminado el botón de guardado situado al final del formulario.
- Aplicado el mismo patrón al menú de datos del vehículo.
- Se mantiene el desplazamiento vertical del contenido.
